...
На протяжении 8 лет занимался развитием коммерчеcкого проекта и вот решил полностью сменить свою сферу деятельности, узнать новое, именно поэтому вы читаете этот текст.
...
- Модуль 6: [Работа в Bash](https://github.com/Trest999/gitbash?tab=readme-ov-file)
